...
is 31 migrations, `0001` through `0031`. This paragraph used to name a head sha and a
...
statement of what this document is about: 31 migrations rather than five, the current head
