...
| 2026-09-13 | [Legible refusal](2026-09-13-legible-refusal.md) | W-9: the section B measurement finished at thirteen of seventeen and the reading-against-running ratio settled at about one to two, the degenerate policy list turned from an exclusion into an assertion, A5 decided under AR-E10 and closed for the three tables that carry wine, one path for the three refusal shapes, and B20's class shown not to be reachable by enumeration |
| 2026-09-13 | [Status, then the oldest debt](2026-09-13-status-and-oldest-debt.md) | W-10: seventy one rulings given a status the tree can check, the client's seven unverified claims declared and counted on every run, the scheduling block moved to core five sessions after it was unblocked, and the ratchet catching a privacy hole whose previous coverage turned out to be fixture breakage |
| 2026-09-14 | [The first pick](2026-09-14-first-pick.md) | Migrations 0032 to 0040: intake and press written the night before the first pick and then changed all morning by a winemaker at a scale, the backup that turned out to be three comment lines, two defects that reached a phone in a vineyard, and an assertion that passed until somebody typed a real number into the running cellar |
| 2026-09-14 | [The first pick](2026-09-14-first-pick.md) | Migrations 0032 to 0040: intake and press written the night before the first pick and then changed all morning by a winemaker at a scale, the backup that turned out to be three comment lines, two defects that reached a phone in a vineyard, and an assertion that passed until somebody typed a real number into the running cellar |
